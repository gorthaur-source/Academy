...
public class Game {
     ...
     */
    private final int manufacturedCars = 25;
    private final int manufacturedAmbulances = 5;
    ...
    public void moveAllCars() throws InterruptedException {
        ...
        if (gameHasWinner && winner!=null) {
            winner.flashColorWinner();
        }
        for (Car ambulance : ambulances) {
            ambulance.move();
