...
abstract public class Car {
    ...
    private GridColor originalColor;
    ...
    public void accelerate(GridDirection direction, int speed) {
        ...
        for (int i = 0; i < speed; i++) {
            ...
            if (!(this instanceof Ambulance)) { // doesn't apply to ambulances
    ...
    public void flashColorWinner() throws InterruptedException { // this is why instance variable originalColor is necessary

        for (int i = 0; i < 100; i++) {

            Thread.sleep(Game.getDelay());
            getPos().setColor(GridColor.ORANGE);
            Thread.sleep(Game.getDelay());
            getPos().setColor(originalColor);
        }
    }
    ...
    public GridColor getOriginalColor() {
        return originalColor;
    }

    public void setOriginalColor(GridColor color) {
        originalColor = color;
    }
