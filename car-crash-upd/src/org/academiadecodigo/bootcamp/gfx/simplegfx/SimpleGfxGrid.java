...
public class SimpleGfxGrid implements Grid {
    ...
    public SimpleGfxGrid(int cols, int rows) {
        ...
        playerOneScoreText = new Text(getX() + 10, 0, "Player one score: " + 0);
        playerTwoScoreText = new Text(74 * getCellSize(), 0, "Player two score: " + 0);
    }
    ...
    public void setPlayerOneScoreText(int playerOneScore) {
        playerOneScoreText.delete();
        playerOneScoreText = new Text(getX() + 10, 0, "Player one score: " + playerOneScore);
        playerOneScoreText.draw();

}

    public void setPlayerTwoScoreText(int playerTwoScore) {
        playerTwoScoreText.delete();
        playerTwoScoreText = new Text(75 * getCellSize(), 0, "Player two score: " + playerTwoScore);
        playerTwoScoreText.draw();
