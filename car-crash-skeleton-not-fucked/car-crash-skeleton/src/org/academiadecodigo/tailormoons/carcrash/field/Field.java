...
public final class Field {
     ...
     */
    public static void draw(Car[] cars, Car ambulance) {

        screen.clear();

        if(!ambulance.getCrashed()) screenWriter.drawString(ambulance.getPos().getCol(), ambulance.getPos().getRow(), ambulance.toString());
