...
public abstract class AbstractGridPosition implements GridPosition {
     ...
     */
    public AbstractGridPosition(int col, int row, Grid grid, int sizeMultiplier) {
        this.col = col;
        this.row = row;
        this.grid = grid;
    ...
    public void moveDown(int dist) {
        ...
        int maxRowsDown = dist > getGrid().getRows() - (getRow() + sizeMultiplier) ? getGrid().getRows() - (getRow() + sizeMultiplier) : dist;
    ...
    public void moveRight(int dist) {
        int maxRowsRight = dist > getGrid().getCols() - (getCol() + sizeMultiplier) ? getGrid().getCols() - (getCol() + sizeMultiplier) : dist;
