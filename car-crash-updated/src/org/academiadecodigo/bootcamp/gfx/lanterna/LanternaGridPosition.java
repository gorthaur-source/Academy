...
public class LanternaGridPosition extends AbstractGridPosition {
     ...
     */
    public LanternaGridPosition(LanternaGrid grid, int sizeMultiplier) {
     ...
     * @param grid  the grid where the position will live on
     */
    public LanternaGridPosition(int col, int row, LanternaGrid grid, int sizeMultiplier) {

        super(col, row, grid, sizeMultiplier);
        show();
